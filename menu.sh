...
echo -e  "  ══════════════════════════════════════════════════════════════════" | lolcat
echo '         	                      UNLIMITED INTERNET!                '
echo -e ""
echo -e "\e[1;94m=============================-Menu-=============================\e[0m"
echo -e "\e[1;94m*               Pakya AutoScriptVPN\e[0m"
echo -e ""
echo -e "\e[1;94m    .----------------------------------------------------.    "
echo -e "\e[1;94m    |                    MAIN MENU                       |    "
echo -e "\e[1;94m    '----------------------------------------------------'    "
echo -e "\e[0m                                                               "
